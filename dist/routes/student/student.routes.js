...
const studentController = __importStar(require("../../controllers/student/student.controller"));
const auth_middleware_1 = require("../../middleware/auth.middleware");
const rbac_middleware_1 = require("../../middleware/rbac.middleware");
const validate_middleware_1 = require("../../middleware/validate.middleware");
const student_validation_1 = require("../../validations/student/student.validation");
const router = (0, express_1.Router)();
router.use(auth_middleware_1.verifyToken);
// Student self-service routes (MUST be before /:id to avoid "me" being treated as an ID)
router.get("/me", (0, rbac_middleware_1.checkRole)("student"), studentController.getMyProfile);
router.get("/me/exam-results", (0, rbac_middleware_1.checkRole)("student"), studentController.getMyExamResults);
router.route("/")
