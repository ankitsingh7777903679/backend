...
const auth_validation_1 = require("../../validations/auth/auth.validation");
const router = (0, express_1.Router)();
router.post("/register", (0, validate_middleware_1.validate)("body", auth_validation_1.registerInstituteSchema), authController.registerInstitute);
