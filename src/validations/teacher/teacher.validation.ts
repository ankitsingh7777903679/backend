...
export const createTeacherSchema = z.object({
  ...
  teachingType:    z.enum(["coaching", "home_tuition", "both"]).default("coaching"),
  portalAccess:    z.enum(["disabled", "invited", "active"]).optional(),
  portalAccessEnabled: z.boolean().optional().default(true),
